                            ...
                            <div class="relative">
                                ...
                                <form action="/search" method="POST">
                                    ...
                                    <input id="search-top" name="query"
                                        class="block w-full rounded-md border-0 bg-white py-1.5 pl-10 pr-3 text-white ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
